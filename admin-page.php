...
<html>
  ...
  <body>
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
      ...
      <li class="nav-brand dropdown col-md-3 col-lg-2 me-0 px-3 fs-6">
        <a class="nav-brand" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <span class="mr-2 d-none d-lg-inline text-white small"><?php echo $_SESSION['first_name'] . ' ' . $_SESSION['last_name'];?></span>
